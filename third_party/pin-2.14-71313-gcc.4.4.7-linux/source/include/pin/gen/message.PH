...
class MESSAGE_TYPE
{
  ...
  public:
    ...
    STATIC NORETURN VOID PrintMessageAndExit(const char *message, const char *message2,
  ...
  public:
    ...
    VOID NORETURN MessageNoReturn(const string& message, BOOL printPrefix = TRUE,
                 PIN_ERRTYPE errType = PIN_ERR_NONE, INT32 numArgs=0, ...);
