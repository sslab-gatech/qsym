...
typedef VOID (*CODECACHE_TRACEINVALIDATED_CALLBACK)(ADDRINT orig_pc, 
    ADDRINT cache_pc, BOOL success);
                                                                  ...
                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddCacheInitFunction(CODECACHE_NOARG_CALLBACK fun, VOID *val);

                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddCacheBlockFunction(CODECACHE_CACHEBLOCK_CALLBACK fun, VOID *val);

                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddFullCacheFunction(CODECACHE_FULL_CALLBACK fun, VOID *val);

                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddCacheFlushedFunction(CODECACHE_NOARG_CALLBACK fun, VOID *val);

                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddCodeCacheEnteredFunction(CODECACHE_ENTEREXIT_CALLBACK fun, VOID *val);

                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddCodeCacheExitedFunction(CODECACHE_ENTEREXIT_CALLBACK fun, VOID *val);

                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddTraceLinkedFunction(CODECACHE_LINKED_CALLBACK fun, VOID *val);

                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddTraceUnlinkedFunction(CODECACHE_UNLINKED_CALLBACK fun, VOID *val);

                                                                  /* DO NOT EDIT */
extern PIN_CALLBACK CODECACHE_AddTraceInvalidatedFunction(CODECACHE_TRACEINVALIDATED_CALLBACK fun, VOID *val);
